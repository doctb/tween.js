 ...
 * @author Tabletop Pixel / http://www.tabletop-pixel.com
 */
...
TWEEN.Tween = function ( object ) {
	...
	this.setValuesStart = function(obj) {
		_valuesStart = obj;
		return this;
	};
	...
	this.update = function ( time ) {
		...
		if (!_loop && elapsed == 1 ) {
			...
			return false;
		} else if (_loop && elapsed >= 1 ) {
			elapsed = elapsed - 1;
			_startTime = _startTime + _duration;
		}
		return true;
	};
};
